...
magick_attr_antialias <- function(input, antialias) {
    .Call('magick_magick_attr_antialias', PACKAGE = 'magick', input, antialias)
}
...
magick_attr_density <- function(input, geometry) {
    .Call('magick_magick_attr_density', PACKAGE = 'magick', input, geometry)
}
...
magick_attr_gifmethod <- function(input, method) {
    .Call('magick_magick_attr_gifmethod', PACKAGE = 'magick', input, method)
}
...
magick_attr_matte <- function(input, matte) {
    .Call('magick_magick_attr_matte', PACKAGE = 'magick', input, matte)
}

magick_attr_mattecolor <- function(input, color) {
    .Call('magick_magick_attr_mattecolor', PACKAGE = 'magick', input, color)
}

magick_attr_pencolor <- function(input, color) {
    .Call('magick_magick_attr_pencolor', PACKAGE = 'magick', input, color)
}
...
magick_image_annotate <- function(input, text, gravity, location, degrees, color, boxcolor, font, size) {
    .Call('magick_magick_image_annotate', PACKAGE = 'magick', input, text, gravity, location, degrees, color, boxcolor, font, size)
}
