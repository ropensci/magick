...
magick_image_annotate <- function(input, text, gravity, location, degrees, font, size, color, strokecolor, boxcolor) {
    .Call('magick_magick_image_annotate', PACKAGE = 'magick', input, text, gravity, location, degrees, font, size, color, strokecolor, boxcolor)
}
