...
You can capture the contents of an R graphics device, allowing you to manipulate
plots.  The R graphics device must be one of the bitmap devies such as `png()`
or `jpeg()`.  `Cairo::Cairo(type="raster")` creates in-memory bitmaps without
